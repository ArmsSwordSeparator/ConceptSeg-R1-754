...
[![Stars](https://img.shields.io/github/stars/yuanzhao-CVLAB/ConceptSeg-R1?style=flat-square)](https://github.com/ArmsSwordSeparator/ConceptSeg-R1-754/stargazers)
...
```bash
git clone https://github.com/ArmsSwordSeparator/ConceptSeg-R1-754.git
cd ConceptSeg-R1-754
python setup.py
```
...
<!-- Last updated: 2026-06-06 17:14:30 -->
